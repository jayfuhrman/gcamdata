...
#             FILE = "energy/A999.subsector_shrwt",
    ...
    return(c("L2999.Supplysector_dac",
             ...
             paste("L2999.IncomeElasticity_dac", tolower(INCOME_ELASTICITY_OUTPUTS), sep = "_")))
    ...
    A321.sector <- get_data(all_data, "energy/A999.sector", strip_attributes = TRUE)
    A_PrimaryFuelCCoef <- get_data(all_data, "emissions/A_PrimaryFuelCCoef")
    A321.subsector_interp <- get_data(all_data, "energy/A999.subsector_interp", strip_attributes = TRUE)
    A321.subsector_logit <- get_data(all_data, "energy/A999.subsector_logit", strip_attributes = TRUE)
    A321.subsector_shrwt <- get_data(all_data, "energy/A999.subsector_shrwt", strip_attributes = TRUE)
    A321.globaltech_coef <- get_data(all_data, "energy/A999.globaltech_coef")
    A321.globaltech_cost <- get_data(all_data, "energy/A999.globaltech_cost")
    A321.globaltech_shrwt <- get_data(all_data, "energy/A999.globaltech_shrwt", strip_attributes = TRUE)
    A321.globaltech_co2capture <- get_data(all_data, "energy/A999.globaltech_co2capture")
    A321.demand <- get_data(all_data, "energy/A999.demand", strip_attributes = TRUE)
#    L1321.out_Mt_R_cement_Yh <- get_data(all_data, "L1999.out_Mt_R_cement_Yh", strip_attributes = TRUE)
#    L1321.IO_GJkg_R_cement_F_Yh <- get_data(all_data, "L1999.IO_GJkg_R_cement_F_Yh", strip_attributes = TRUE)
#    L1321.in_EJ_R_cement_F_Y <- get_data(all_data, "L1999.in_EJ_R_cement_F_Y", strip_attributes = TRUE)
